...
/** getSpaceLevelAnalyze POST /api/space/analyze/level */
export async function getSpaceLevelAnalyzeUsingPost(
  body: API.SpaceLevelAnalyzeRequest,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponseListSpaceLevelAnalyzeResponse_>('/api/space/analyze/level', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
